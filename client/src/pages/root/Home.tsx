      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            const post = entry.target.getAttribute('data-post-id');
            if (post) {
  ...
  return (
    <section className="flex flex-col gap-4 pt-3 pb-44 xl:pb-20">
      <div className="lg:mx-auto xl:pr-[20%]">
        ...
        <p className="w-[98%] md:w-[80%] mx-auto text-xs text-center text-gray-400">Tip: (You can tell AI to like a post, save a post, comment to a post, navigate to different pages)</p>
      </div>
