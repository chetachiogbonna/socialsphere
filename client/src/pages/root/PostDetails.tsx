...
import { AISpeak, checkIfPostIsBookmarked, checkIfPostIsLiked, cn, convertToReadableDateString, navigationPath } from "@/lib/utils";
                      ...
                      <div key={comment.postId + crypto.randomUUID()} className="rounded-lg flex justify-end items-end last:pb-5 w-[90%] ml-auto">
                        <div className="w-full flex items-start justify-end mb-2 gap-3">
                          ...
                          <div className="w-28 h-28 rounded-full">
                            <img className="w-10 h-10 rounded-full" src={comment.commentProfilePicUrl || "/assets/images/profile-placeholder.jpg"} alt="profile pic" />
                          </div>
                        </div>
                      </div>
                    )
