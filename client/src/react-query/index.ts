...
import { bookmarkAndUnbookPost, chatFriend, commentToPost, createNewPost, createNewUserAccount, deletePost, getAllPosts, getAllUsers, getFriendsChats, getPostById, getPostByUser, getUserById, likeAndUnlikePost, setUserProfile, signInUserAccount, updatePost } from "@/lib/config/api";
...
export const useUpdatePost = () => {
  ...
  return useMutation({
    mutationFn: (postToUpdate: Post) => updatePost(postToUpdate),
    onSuccess: (_, post) => {
      queryClient.invalidateQueries({
        queryKey: ["posts"]
      });
